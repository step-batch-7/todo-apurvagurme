...
app.get('/todoList', authorize, serveSavedTodoList);
...
app.post(['/addTodo', '/renameTodo', '/deleteTodo', '/addTask', '/renameTask', '/toggleTaskStatus', '/deleteTask'], authorize);
